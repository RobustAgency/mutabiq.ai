...
class AiModelArtifactImportServiceTest extends TestCase
{
    ...
    public function test_it_imports_artifacts_from_csv_file(): void
    {
        Storage::fake('local');
    ...
    public function test_it_imports_multiple_artifacts(): void
    {
        Storage::fake('local');
    ...
    public function test_it_imports_artifacts_with_nullable_fields(): void
    {
        Storage::fake('local');
    ...
    public function test_it_continues_on_row_errors(): void
    {
        Storage::fake('local');
    ...
    public function test_it_validates_invalid_file_extension(): void
    {
    ...
    public function test_it_accepts_csv_files(): void
    {
        Storage::fake('local');
    ...
    public function test_it_generates_import_template(): void
    {
        ...
        $this->assertStringContainsString('ai_model_version_id', $content);
        $this->assertStringContainsString('uri', $content);
        $this->assertStringContainsString('checksum', $content);
        $this->assertStringContainsString('size_bytes', $content);
    ...
    public function test_it_validates_artifact_type(): void
    {
        $this->assertTrue($this->service->isValidArtifactType(ArtifactType::MODEL_BINARY->value));
        $this->assertTrue($this->service->isValidArtifactType(ArtifactType::TOKENIZER->value));
        $this->assertTrue($this->service->isValidArtifactType(ArtifactType::CONFIG->value));
        $this->assertFalse($this->service->isValidArtifactType('invalid_type'));
        $this->assertFalse($this->service->isValidArtifactType(''));
    }

    public function test_it_imports_all_artifact_types(): void
    {
        Storage::fake('local');
        ...
        foreach (ArtifactType::cases() as $type) {
            ...
            $this->assertTrue($result['success'], "Failed to import artifact type: {$type->value}");
            $this->assertDatabaseHas('ai_model_artifacts', [
    ...
    public function test_it_handles_large_batch_imports(): void
    {
        Storage::fake('local');
    ...
    public function test_it_validates_uri_max_length(): void
    {
        Storage::fake('local');
    ...
    public function test_it_validates_negative_size_bytes(): void
    {
        Storage::fake('local');
