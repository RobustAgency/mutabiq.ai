...
class UpdateAiModelCardRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'organizational_context' => ['sometimes', 'nullable', 'array'],
            ...
            'last_review_date' => ['sometimes', 'date', 'nullable', 'before_or_equal:today'],
            'next_review_date' => ['sometimes', 'date', 'nullable', 'after_or_equal:today'],
